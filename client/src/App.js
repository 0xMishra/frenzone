      ...
      {!currentAccount ? (
        ...
        <section className="flex justify-center items-center ">
          <form
            ...
            w-[80vw] max-w-[700px]
            border-[1px] border-[#74c8b6] border-solid p-6 rounded-md"
          >
            <input
            ...
            <textarea
              ...
              value={desc}
              className="flex justify-start items-center flex-col
   bg-[transparent] text-white w-[70%] focus:border-[#74c8b6]
            border-[1px] border-[#74c8b6] border-solid p-6 rounded-md h-[250px]"
            ...
            <button
              ...
              border-[1px] border-[#74c8b6] border-solid  text-[#74c8b6]
              hover:bg-[#74c8b6] hover:text-white
              "
            >
              POST
            </button>
